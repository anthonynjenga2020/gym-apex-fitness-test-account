...
import ClassBookingModal from '../components/ClassBookingModal.jsx'
              ...
              {days.map(day => (
                <button
                  ...
                  className={`px-4 py-2.5 rounded-sm text-xs font-black uppercase tracking-widest whitespace-nowrap transition-all duration-200 border ${
                    activeDay === day ? 'text-white shadow-lg' : 'text-gray-500 hover:text-gray-300'
                  }`}
                  style={{
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-3 mb-1">
                      ...
                      <span
                        className="text-xs font-bold px-2 py-0.5 rounded-sm uppercase tracking-widest"
                        style={{
